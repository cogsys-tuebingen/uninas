...
from uninas.networks.abstract2 import AbstractExternalNetwork
...
class FCProfilingNetwork(AbstractExternalNetwork):
    ...
    def __init__(self, *args, layer_widths: str, act_fun: str, use_bn: bool, use_bias: bool, **kwargs):
        ...
        assert len(self._layer_widths) > 0, "Must have at least one intermediate layer"
